...
public class AppTest 
{
    ...
    public static Object[][] proveedorDatos(){
        return new Object[][] {
            {"masculino", "18", "El valor de la prima anual es el seguro de auto según su género y edad es 2000 dólares"},
            {"masculino", "24", "El valor de la prima anual es el seguro de auto según su género y edad es 2000 dólares"},
            {"masculino", "25", "El valor de la prima anual es el seguro de auto según su género y edad es 1000 dólares"},
            {"masculino", "64", "El valor de la prima anual es el seguro de auto según su género y edad es 1000 dólares"}
